...
import sg.edu.nus.iss.vmcs.logging.LoggerController;
...
public class TransactionController {
	 ...
	 */
	public TransactionController(MainController mainCtrl, int changeStrategy) {
		this.mainCtrl = mainCtrl;
		dispenseCtrl=new DispenseController(this);
		coinReceiver=new CoinReceiver(this);
		switch(changeStrategy){
		case ChangeGiver.LargerDenominationFirst:
			changeGiver=new ChangeLargerDenominationFirst(this);
			break;
		case ChangeGiver.BalancedDenominations:
			changeGiver=new ChangeBalancedDenomination(this);
			break;
		}
	}
